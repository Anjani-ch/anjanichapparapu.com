...
function HomePage() {
  return (
    <section className="my-40 flex items-center justify-between flex-col-reverse md:flex-row">
      <div>
        <h1 className="text-5xl text-center font-bold tracking-tight mb-7 mt-4 md:mb-9 md:mt-0 md:text-left md:text-6xl xl:text-7xl">Anjani <span className="text-blue-600 dark:text-blue-500">Chapparapu</span></h1>
